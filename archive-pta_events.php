...
<?php get_header(); ?>
	<div class="flex flex-col md:flex-row min-h-screen">
		<main id="content" class="flex-1 py-12 px-4">
						...
						<article id="post-<?php the_ID(); ?>" class="relative isolate flex flex-col gap-8 lg:flex-row <?php  post_class(); ?>">
							...
							<div>
								<div class="flex items-center gap-x-4 text-xs">
									...
									<a href="<?php the_permalink(); ?>" rel="bookmark" aria-label="Read more about <?php echo esc_attr( get_the_title() ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>" class="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100"><?php the_title(); ?></a>
								</div>
								<div class="group relative max-w-xl">
									<h3 class="mt-3 text-lg/6 font-semibold text-gray-900 group-hover:text-gray-600">
										<a href="<?php the_permalink(); ?>" rel="bookmark" aria-label="Read more about <?php echo esc_attr( get_the_title() ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>">
