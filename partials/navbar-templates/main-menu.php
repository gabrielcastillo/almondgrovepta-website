...
<div id="primary-nav" class="hidden sm:ml-6 sm:block">
    <div class="flex space-x-4">
		<?php foreach( $menu_items as $menu_list ): ?>
			...
			<?php else: ?>
                <a href="<?php echo $menu_list['url']; ?>" class="<?php echo ( $current_slug === $slug ) ? esc_attr('bg-red-700 text-white') : ''; ?> text-gray-800 hover:bg-red-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page"><?php echo $menu_list['title']; ?></a>
			<?php endif; ?>
		<?php endforeach; ?>
    </div>
</div>