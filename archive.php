                        ...
                        <article id="post-<?php the_ID(); ?>" class="relative isolate flex flex-col gap-8 lg:flex-row <?php  post_class(); ?>">
                            ...
                            <div class="w-full">
                                ...
                                <div class="flex items-center gap-x-2 text-xs">
                                    Posted on:<time datetime="2020-03-16" class="text-gray-500"><?php echo get_the_date(); ?></time>
                                ...
                                <div class="group relative max-w-xl">
                                    ...
                                    <p class="mt-5 text-sm/6 text-gray-600"><?php custom_excerpt( get_the_excerpt() ); ?></p>
