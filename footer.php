...
<footer class="bg-gray-900">
    <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <div class="mt-16 flex justify-center gap-x-10">
            ...
            <a href="<?php echo esc_url( $settings['facebook_url'] ); ?>" class="text-gray-400 hover:text-gray-300">
            ...
            <a href="<?php echo esc_url( $settings['instagram_url'] ); ?>" class="text-gray-400 hover:text-gray-300">
            ...
            <a href="<?php echo esc_url( $settings['twitter_url'] ); ?>" class="text-gray-400 hover:text-gray-300">
            ...
            <a href="<?php echo esc_url( $settings['youtube_url'] ); ?>" class="text-gray-400 hover:text-gray-300">
